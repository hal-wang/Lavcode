...
namespace Hubery.Lavcode.Uwp.View.PasswordDetail
{
    public class PasswordDetailViewModel : ViewModelBase
    {
        ...
        private Icon _icon = Model.Icon.GetDefault(StorageType.Password);
        public Icon Icon
        {
            get { return _icon; }
        ...
        private List<Model.KeyValuePair> _oldKeyValuePairs = new List<Model.KeyValuePair>();
        ...
        private async Task SetPassword(Password password)
        {
            ...
            else
            {
                ...
                SetKeyValuePairs(await helper.GetKeyValuePairs(password.Id));
                Icon = await helper.GetIcon(_oldPassword.Id);
                _oldIcon = Icon;
            }
        }
        ...
        private async Task<bool> Save()
        {
            ...
            if (_oldPassword == null)
            {
                await helper.AddPassword(newPassword, Icon, CurKeyValuePairs);
            }
            else
            {
                await helper.UpdatePassword(newPassword, Icon, CurKeyValuePairs);
            }
        ...
        private List<Model.KeyValuePair> CurKeyValuePairs
        {
            get
            {
                List<Model.KeyValuePair> result = new List<Model.KeyValuePair>();
        ...
        public async void DeleteCommand()
        {
            ...
            using var helper = new SqliteHelper();
            await helper.DeletePassword(_oldPassword.Id);
